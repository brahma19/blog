...
2. **Google Cloud Dataproc**: Executes a Python script on a cluster (8-core master, 2–4 workers) to consume messages, batch them, and write to Pub/Sub and BigQuery.
